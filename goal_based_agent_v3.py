...
@tool(description="Extract a user's name, email, and skills from their message.")
...
# Goal checker
@tool(description="Check whether the user's name, email, and skills have been collected.")
